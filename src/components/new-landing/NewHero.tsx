  ...
  return <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container relative">
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-card backdrop-blur-sm border border-border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300">
          ...
          <div className="bg-card backdrop-blur-sm border border-border rounded-2xl p-6 text-center hover:shadow-lg transition-all duration-300">
            <div className="w-24 h-24 mx-auto mb-4 rounded-full bg-primary/20 flex items-center justify-center">
              <span className="text-primary font-bold text-3xl">10×</span>
            </div>
            <div className="text-2xl font-bold text-primary mb-1">Faster</div>
