          ...
          <div className="p-6">
            <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button 
                  onClick={handleDemo}
                  className="bg-cogintech-teal hover:bg-cogintech-teal/90 text-white w-full sm:w-auto mt-2 sm:mt-0 px-6 py-3 rounded-lg font-medium transition-colors disabled:opacity-50"
