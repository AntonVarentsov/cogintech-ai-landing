        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button variant="accent" size="lg" className="font-medium px-8 py-6" onClick={() => document.getElementById('lead-form')?.scrollIntoView({
              behavior: 'smooth'
            })}>
                Request a Free Consultation
                <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
              <Button variant="outline" size="lg" className="font-medium px-8 py-6" onClick={() => document.getElementById('demo')?.scrollIntoView({
              behavior: 'smooth'
            })}>
                See How It Works
              </Button>
          ...
          <div className="relative h-80 sm:h-96 md:h-[500px] rounded-xl overflow-hidden bg-gradient-to-b from-background to-primary/5">
            ...
            <div className="absolute bottom-0 left-0 right-0 h-20 bg-gradient-to-t from-primary/10 to-transparent rounded-b-xl"></div>
          </div>
        </div>
      </div>
    </section>;
