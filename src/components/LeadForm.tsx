...
const LeadForm = () => {
  ...
  return <section id="lead-form" className="section bg-primary text-white">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-secondary/20 flex items-center justify-center mr-4 flex-shrink-0 mt-1">
              ...
              <div className="mt-12 p-6 bg-white/5 border border-white/10 rounded-lg">
                ...
                <div className="space-y-1 text-white/80">
                  <div>Email: <a href="mailto:vr@cogintech.com" className="text-secondary hover:underline">vr@cogintech.com</a></div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-4 sm:p-8 w-full">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <Input id="name" name="name" value={formData.name} onChange={handleChange} required className="bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-secondary mt-1 w-full" placeholder="John Smith" />
                </div>
                
                <div>
                  <Label htmlFor="company">Company</Label>
                  <Input id="company" name="company" value={formData.company} onChange={handleChange} className="bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-secondary mt-1 w-full" placeholder="Acme Oil & Gas Ltd." />
                </div>
                
                <div>
                  <Label htmlFor="role">Your Role</Label>
                  <Select onValueChange={handleSelectChange} value={formData.role}>
                    <SelectTrigger className="bg-white/10 border-white/20 text-white focus:ring-secondary mt-1 w-full">
                ...
                <div>
                  ...
                  <Input 
                    ...
                    required
                    className={`bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-secondary mt-1 w-full ${
                      !emailValidation.isValid ? 'border-accent' : ''
                    }`}
                    placeholder="vr@cogintech.com" 
                  />
                  {!emailValidation.isValid && emailValidation.error && (
                    <p className="text-accent text-sm mt-1">{emailValidation.error}</p>
                  )}
                </div>
                
                <div>
                  <Label htmlFor="phone">Phone Number</Label>
                  <Input id="phone" name="phone" value={formData.phone} onChange={handleChange} className="bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-secondary mt-1 w-full" placeholder="Enter your phone number" />
                </div>
                
                <div>
                  <Label htmlFor="comments">Additional Comments (Optional)</Label>
                  <Textarea id="comments" name="comments" value={formData.comments} onChange={handleChange} className="bg-white/10 border-white/20 text-white placeholder:text-white/50 focus-visible:ring-secondary h-24 mt-1 w-full" placeholder="Tell us about your current inspection analysis process..." />
                </div>
